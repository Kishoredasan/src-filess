...
if(c == true)
{
sts="file created sucessfully";
}
else
{
sts="file not created ";
}   
	...
	String d=formatter.format(date);
         ...
         String sql = "INSERT INTO Fdetails (filename,size,lastmodified) "
            + "VALUES('"+s+"','"+file.length()+"','"+d+"' );";
